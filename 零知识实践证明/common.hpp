...
// x*x*x= w_3
pb.add_r1cs_constraint(r1cs_constraint<FieldT>(w_2, x, w_3));
// x*x*x+x=w_4
pb.add_r1cs_constraint(r1cs_constraint<FieldT>(w_3+x, 1, w_4));
//w_4+5=w_5
pb.add_r1cs_constraint(r1cs_constraint<FieldT>(w_4+5, 1, w_5));
//w_5=out
pb.add_r1cs_constraint(r1cs_constraint<FieldT>(1, w_5, out));
